...
export function buildChapterGenerationPrompt(
    ...
    return [
        ...
        'Use markdown headings on their own line, blank lines between paragraphs, and proper numbered or bullet lists when needed.',
        'Do not place explanatory paragraph text on the same line as a markdown heading.',
        'Do not split bold or italic markers across line breaks.',
