	...
	return (
		<div className="rounded-[14px] border border-[#E5E5E7] bg-white p-5">
			<div className="mb-4">
				...
				<p className="mt-1 text-[12px] text-[#86868B]">
					These settings shape the persistent context appended to
					...
					<select
						...
						onChange={(event) =>
							props.onChange({
								...props.value,
								tone: event.target
									.value as BackendAuthoringConfig["tone"],
							})
						}
						className="w-full rounded-[12px] border border-[#E5E5E7] px-4 py-3 text-[14px] focus:border-[#4ADE80] focus:outline-none"
					>
				...
				<div>
					...
					<select
						...
						onChange={(event) =>
							props.onChange({
								...props.value,
								learnerLevel: event.target
									.value as BackendAuthoringConfig["learnerLevel"],
							})
						}
						className="w-full rounded-[12px] border border-[#E5E5E7] px-4 py-3 text-[14px] focus:border-[#4ADE80] focus:outline-none"
					>
						...
						<div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
							<div>
								...
								<p className="mt-1 text-[13px] text-[#6B7280]">
									These settings default from `.env`, and
									right now they are stored in backend memory
