...
import {dashboardApi, type ModelEntryDto} from "@/dashboard/api/dashboardApi";
...
export function ModelsStep({
	...
	const [silverModels, setSilverModels] = useState<ModelEntryDto[]>([]);
	const [goldModels, setGoldModels] = useState<ModelEntryDto[]>([]);
