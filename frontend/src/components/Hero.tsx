		...
		<section className="relative w-[1300px] h-[1180px] overflow-hidden rounded-xl mb-10">
			...
			<div className="relative z-10 flex flex-col items-center pt-12 sh">
				...
				<p className="font-inter text-2xl text-dark/80 text-center max-w-2xl leading-relaxed mb-10">
					Didactio uses AI and pedagogical expertise to generate
					high-quality, structured learning content tailored to your
					needs.
				</p>

				<Link
					to="/dashboard"
					className="bg-accent text-dark font-sora font-semibold text-xl px-10 py-4 rounded-full hover:bg-accent/90 transition-colors mb-16"
				>
					Start now, free
				</Link>
