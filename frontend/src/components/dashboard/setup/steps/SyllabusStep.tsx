...
import type {GenerationModelOption} from "@/shared/models/generationModels";
...
type SyllabusStepProps = {
	...
	selectedGenerationTier: GenerationQualityDto;
	setSelectedGenerationTier: Dispatch<SetStateAction<GenerationQualityDto>>;
	onGenerateSyllabus: (tier: GenerationQualityDto) => Promise<void>;
	onStartGeneration: (tier: GenerationQualityDto) => Promise<void>;
...
function ChapterAccordion({
	...
	useEffect(() => {
		...
		// Store measured height so the accordion can animate to content size.
...
function SyllabusCard({
	...
	isStreaming: boolean;
	activeTier: GenerationQualityDto | null;
}) {
