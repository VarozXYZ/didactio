...
import {buildDashboardFolders, buildUnitLibraryItems} from "@/dashboard/viewModelMappers";
import {UnitLibraryView} from "./library/UnitLibraryView";
import {CreateUnitButton} from "./library/UnitLibraryHeader";
import {AnalyticsView} from "./settings/AnalyticsView";
...
import {CreateUnitWizard} from "./setup/CreateUnitWizard";
import {useMediaQuery} from "@/dashboard/hooks/useMediaQuery";
import type {UnitLibraryItem, DashboardSection} from "@/dashboard/types";
...
export default function DashboardShell() {
	...
	const [items, setItems] = useState<UnitLibraryItem[]>([]);
