...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description
    ref={ref}
    className={cn("text-[13px] text-[#86868B] leading-relaxed", className)}
    {...props}
  />
))
